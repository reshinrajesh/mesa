...
export const mockUser: User = {
  ...
  phone: '+91 98455 12048',
  avatarUrl: avatarPhoto[0],
  favoriteCuisines: ['south-indian', 'coastal', 'cafe'],
  dietary: ['pescatarian'],
  savedPlaces: [
    {
      id: 'place_home',
      label: 'Home',
      address: '18, 5th Cross, Indiranagar, Bengaluru 560038',
      latitude: 12.9719,
      longitude: 77.6412,
    },
    {
      id: 'place_work',
      label: 'Work',
      address: 'Prestige Tower, Residency Road, Bengaluru 560025',
      latitude: 12.9698,
      longitude: 77.6035,
    },
  ],
...
export function seedReservations(): Reservation[] {
  ...
  return [
    {
      id: 'rsv_ilaya_upcoming',
      code: 'K7RD24',
      restaurantId: 'rst_ilaya',
      date: sittingOn('rst_ilaya', 2, '19:30'),
      time: '19:30',
      partySize: 2,
      seating: 'window',
      ...
      createdAt: iso(-6),
      updatedAt: iso(-6),
      venueMessage: 'Table 4 by the window is yours. See you Thursday.',
    },
    {
      id: 'rsv_thindi_upcoming',
      code: 'M2XQ81',
      restaurantId: 'rst_thindi',
      date: sittingOn('rst_thindi', 6, '18:30'),
      time: '18:30',
      partySize: 3,
      seating: 'outdoor',
      occasion: 'none',
    ...
    },
    {
      ...
      id: 'rsv_guntur_waitlist',
      restaurantId: 'rst_guntur',
      date: sittingOn('rst_guntur', 3, '20:30'),
      time: '20:30',
      partySize: 2,
      seating: 'any',
      occasion: 'date-night',
    ...
    },
    {
      ...
      id: 'rsv_filterfoam_noshow',
      code: 'T8FK40',
      restaurantId: 'rst_filterfoam',
    ...
    {
      id: 'rsv_whitefield_cancelled',
      code: 'C3VN19',
      restaurantId: 'rst_whitefield',
  ...
  return [
    {
      ...
      title: 'Ilaya in two days',
      body: 'Thursday at 7:30 PM for 2, window table. Tap to see your booking code.',
      createdAt: iso(3),
      readAt: null,
      href: '/reservation/rsv_ilaya_upcoming',
      restaurantId: 'rst_ilaya',
      reservationId: 'rsv_ilaya_upcoming',
    },
    {
      id: 'ntf_2',
      kind: 'reservation-confirmed',
      title: 'Thindi Beedi is holding your table',
      body: 'Your request for 3 at 6:30 PM is with the restaurant. They usually reply within an hour.',
      createdAt: iso(19),
      readAt: null,
      href: '/reservation/rsv_thindi_upcoming',
      restaurantId: 'rst_thindi',
      reservationId: 'rsv_thindi_upcoming',
    },
    {
      id: 'ntf_3',
      kind: 'restaurant-offer',
      title: 'Copper Kettle has a new stout on tap',
      body: 'A coffee stout brewed with Chikmagalur beans, on until the end of the month.',
      createdAt: iso(30),
      readAt: iso(28),
      href: '/restaurant/rst_copperkettle',
      restaurantId: 'rst_copperkettle',
    },
    {
      id: 'ntf_4',
      kind: 'rating-request',
      title: 'How was Kundapura Coast?',
      body: 'You dined there last week. A rating helps the next person decide.',
      createdAt: iso(72),
      readAt: iso(70),
      href: '/reservation/rsv_kundapura_past',
      restaurantId: 'rst_kundapura',
      reservationId: 'rsv_kundapura_past',
    },
    {
      id: 'ntf_5',
      kind: 'reservation-cancelled',
      title: 'Halli Mane booking cancelled',
      body: 'Your table for 6 on the 8th was cancelled. Nothing was charged.',
      createdAt: iso(168),
      readAt: iso(160),
      href: '/reservation/rsv_whitefield_cancelled',
      restaurantId: 'rst_whitefield',
      reservationId: 'rsv_whitefield_cancelled',
    },
  ];
}

/** Restaurants a fresh install starts with saved, so Favourites is never empty. */
export const seedFavoriteIds = ['rst_ilaya', 'rst_thindi', 'rst_copperkettle'];
